...
<div class="container">
  ...
  <form name="myform" method="post">
	  <table class="table table-bordered">
	    ...
	    <tr>
	      <th>이메일</th>
	      <td><input type="text" name="buyer_email" value="baik5634@naver.com" class="form-control"/></td>
	    </tr>
	    <tr>
	      <th>주문자</th>
	    ...
	    <tr>
	      <th>연락처</th>
	      <td><input type="text" name="buyer_tel" value="010-7125-5634" class="form-control"/></td>
	    </tr>
	    <tr>
	      <th>주소</th>
