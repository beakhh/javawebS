...
<div class="w3-top">
  <div class="w3-bar w3-black w3-card">
    ...
    <a href="http://192.168.50.85:9090/javawebS" class="w3-bar-item w3-button w3-padding-large">HOME</a>
    <!-- 
    ...
    <c:if test="${sLevel <=3}">
	    ...
	    <div class="w3-dropdown-hover w3-hide-small">
	      ...
	      <div class="w3-dropdown-content w3-bar-block w3-card-4">
	        ...
	        <a href="${ctp}/study/mail/mailForm" class="w3-bar-item w3-button">메일(mail)</a>
	        <a href="${ctp}/study/mail/mailForm2" class="w3-bar-item w3-button">메일2(mail)</a>
	        ...
	        <a href="${ctp}/study/fileUpload/fileUploadForm" class="w3-bar-item w3-button">파일업로드</a>
	      </div>
	    </div>
	    <div class="w3-dropdown-hover w3-hide-small">
